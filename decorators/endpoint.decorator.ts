 ...
 * @param {IEndpointOptions} options - the endpoint options
 * @param {boolean} autoResponse - if false the endpoint won't convert the return of the function to the request response
 */
export function Endpoint(path: string, options: IEndpointOptions = {}, autoResponse = true) {
  return defineEndpoint(path, options, autoResponse)
}
...
export function Get<C extends BaseController>(
  ...
  return defineEndpoint(path, options, autoResponse, REST_METHODS.GET)
}
...
export function Post<C extends BaseController>(
  ...
  return defineEndpoint(path, options, autoResponse, REST_METHODS.POST)
}
...
export function Put<C extends BaseController>(
  ...
  return defineEndpoint(path, options, autoResponse, REST_METHODS.PUT)
}
...
export function Patch<C extends BaseController>(
  ...
  return defineEndpoint(path, options, autoResponse, REST_METHODS.PATCH)
}
...
export function Delete<C extends BaseController>(
  ...
  return defineEndpoint(path, options, autoResponse, REST_METHODS.DELETE)
}
